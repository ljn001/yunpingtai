<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersEdit.aspx.cs" Inherits="SkyLinkCloud.Users.UsersEdit" %>
<!DOCTYPE html>
                                ...
                                <f:Tree ID="treePower" IsFluid="true" CssClass="blockpanel" EnableCollapse="false" ShowHeader="true" Title="用户权限" runat="server" EnableCheckBox="true" CascadeCheck="true" Height="490px">
                                    <Nodes>
                                        <f:TreeNode Text="平台管理" Expanded="true">
                                            ...
                                            <f:TreeNode Text="数据大屏" AttributeDataTag="平台管理|/res/icon/color_swatch.png|/Screen/Screen.aspx" />
                                        </f:TreeNode>
                                        <f:TreeNode Text="统计报表" Expanded="true">
<%--                                            <f:TreeNode Text="营业曲线" AttributeDataTag="统计报表|/res/icon/chart_bar.png|/Report/YingYeQuXian.aspx" />
                                            <f:TreeNode Text="合作单位提成" AttributeDataTag="统计报表|/res/icon/coins.png|/Report/TiChengTongJi.aspx" />
                                            <f:TreeNode Text="员工业绩" AttributeDataTag="统计报表|/res/icon/user_star.png|/Report/EmpPerformance.aspx" />--%>
                                        </f:TreeNode>
