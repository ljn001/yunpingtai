<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserBindInfo.aspx.cs" Inherits="SkyLinkCloud.Mobile.UserBindInfo" %>
<!DOCTYPE html>
			    ...
			    <ItemTemplate>
                    <div class="card">
                        <div style="display:table-cell;vertical-align:middle;">
                            <span style="font-weight:bold;font-size:16px;"><%# Eval("FCusName") %></span>
                        ...
                        <table style="width:100%">
                            <tr>
                                <td style="line-height:26px;">
                                    账号：<%# Eval("FCusUserID") %>（<%# Eval("FCusUserName") %>）
                                    <br />
                                    手机：<%# Eval("FCusUserPhone") %>
                                    <br />
                                    绑定时间：<%# DateTime.Parse(Eval("FBindTime").ToString()).ToString("yyyy-MM-dd HH:mm") %>
                                </td>
                                <td class="tdBtn" style="width:80px;text-align:right;">
                                    ...
                                    <f:Button runat="server" ID="btnDeleteBind" Text="解除绑定" OnClick="btnDeleteBind_Click" ConfirmText="确认对此账号解除绑定吗？" ConfirmTarget="Top" AttributeDataTag='<%# eu.DEC_Encrypt(Eval("FID").ToString()) %>' />
                                </td>
                            </tr>
                        </table>
                    </div>
