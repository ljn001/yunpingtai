<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerEdit.aspx.cs" Inherits="CloudPlatform.Customer.CustomerEdit" %>
<!DOCTYPE html>
                        ...
                        <f:SimpleForm ID="Panel3" BoxFlex="6" MarginRight="10px" runat="server" ShowBorder="false" ShowHeader="false" LabelWidth="140px">
                            <Items>
                                ...
                                <f:DropDownList runat="server" ID="ddlSysType" Label="系统类型">
                                    <f:ListItem Value="生产系统" Text="生产系统" />
                                    <f:ListItem Value="业务系统" Text="业务系统" />
                                </f:DropDownList>
