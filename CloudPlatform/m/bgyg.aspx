<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bgyg.aspx.cs" Inherits="CloudPlatform.m.bgyg" %>
<!DOCTYPE html>
                ...
                <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="false" ShowHeader="false" Layout="VBox" MessageTarget="None" LabelAlign="Left" LabelWidth="80px">
                    <Items>
                        ...
                        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" Layout="Column">
                            <Items>
                                <f:TextBox runat="server" ID="txtChejian" Label="车间" ColumnWidth="30%" Readonly="true" />
                                <f:TextBox runat="server" ID="txtUserName" Label="员工姓名" ColumnWidth="40%" Readonly="true" />
                                <f:TextBox runat="server" ID="txtUserID" Label="员工工号" ColumnWidth="30%" CssClass="ColMargin" Readonly="true" />
                            </Items>
                        </f:Panel>
                        ...
                        <f:TextBox runat="server" ID="txtTuzhihao" Label="图纸号" Readonly="true" />
                        <f:TextBox runat="server" ID="txtSucai" Label="素材" Readonly="true"  />
                        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" Layout="Column">
                            <Items>
